  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-luxury focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "gradient-primary text-primary-foreground hover:shadow-glow transition-luxury font-medium",
        luxury: "bg-secondary text-secondary-foreground hover:bg-secondary/90 shadow-card border border-primary/20",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border border-primary/30 bg-transparent text-primary hover:bg-primary/10 hover:shadow-glow transition-luxury",
      ...
      size: {
        ...
        lg: "h-13 rounded-lg px-8 text-base font-medium",
        xl: "h-16 rounded-lg px-12 text-lg font-medium",
        icon: "h-11 w-11",
      },
    },
    defaultVariants: {
